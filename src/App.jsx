...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Navigation - Glass bubble style */}
      <header className="fixed top-0 left-0 right-0 z-50 p-4">
        <div className="mx-auto max-w-6xl">
          <div className="glass-panel px-4 py-3 flex items-center justify-between">
            <button
              onClick={() => scrollToId("top")}
              className="group inline-flex items-center gap-3 rounded-xl px-2 py-1 transition hover:bg-white/10"
            ...
            <nav className="hidden items-center gap-1 md:flex">
              {nav.map((item) => (
                <button
                  ...
                  className="rounded-xl px-4 py-2 text-sm font-medium text-foreground/70 transition-all hover:bg-white/10 hover:text-foreground"
                >
                  {item.label}
                </button>
              ))}
            ...
            <div className="flex items-center gap-2">
              <Button
                variant="ghost"
                className="hidden rounded-xl md:inline-flex text-cyan-300 hover:text-cyan-200 hover:bg-cyan-400/10"
              ...
              <Button
                className="rounded-xl bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-400 hover:to-teal-400 text-white shadow-lg shadow-cyan-500/25"
